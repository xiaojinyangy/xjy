            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="{{url('/admin/admin/postadd')}}" method="post" class="form-horizontal js-ajax-form m-t">
                            @csrf
                            <div class="form-group">
                                <label class="col-sm-3 control-label">管理员名：</label>
                                <div class="col-md-6 col-sm-10">
                                    <input name="admin_name" type="text" class="form-control" value="" placeholder="请输入管理员名" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-10">
                                    <div id="uploader" class="wu-example">
                                       ...
                                       <div class="btns">
                                          ...
                                          <input type="hidden" name="admin_img" class="imgs" value="" >
                                       </div>
                                    </div>
                                    <!-- 文件預覽 -->
                                    <div id="admin_img">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-10">
                                    <input name="admin_pwd" type="password" class="form-control" value="" placeholder="请输入密码" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <label class="radio-inline i-checks">
                                        <input type="radio" name="admin_level" checked value="2" /> 管理员
                                </label>
              								</div>
              							</div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-10">
                                    <label class="radio-inline i-checks">
                                            <input type="radio" name="admin_show"  value="1" /> 启用
                                    </label>
                                    <label class="radio-inline i-checks">
                                            <input type="radio" name="admin_show" checked value="2" /> 禁用
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-3">
                                    @if( authchecks('admin/admin/postadd') )
