...
@section('body')
    ...
    <form class="layui-form layui-form-pane" action="" id="from" style="margin: 20px 20px">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label" style="width: 150px">特定区域租金单价</label>
            <div class="layui-input-inline">
                <input type="number" name="rent_money"  class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label" style="width: 150px">特定区域管理费</label>
            <div class="layui-input-inline">
                <input type="number" name="area_rent_money"  class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">综合费</label>
            <div class="layui-input-inline">
                <input type="number" name="incidental_money"  class="layui-input" value="">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="water_money"  class="layui-input" value="">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="number" name="electric_money"  class="layui-input" value="">
            </div>
        </div>
        <div class="layui-form-item">
