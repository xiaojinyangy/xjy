...
<div style="margin:20px">
    <a href="{{url('admin/image/add')}}" class="layui-btn layui-btn-normal layui-btn-mini" lay-event="detail">添加</a>
</div>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            cols: [[
                ...
                {field:'file_path', title: '图片',align:"center",width: '10%', minWidth: 100,type:"image"},
                    ...
                    success:function (data) {
                        if(data.code == 200){
                            ...
                            table.reload('user_table', {
                                url: "{{url('admin/image/index')}}",where: {} //设定异步数据接口的额外参数
                            });
                        }else{
                            layer.msg('删除失败');
                        }
